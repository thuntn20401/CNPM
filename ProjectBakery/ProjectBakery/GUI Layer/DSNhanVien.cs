...
namespace ProjectBakery.GUI_Layer
{
    public partial class DSNhanVien : UserControl
    {
        ...
        {
            dgvDanhSachNhanVien.DataSource = db.getAllNhanVien().Tables[0];
        ...
        private void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng nhập đây đủ thông tin!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        private void load_NhanVienForm(string username)
        {
        ...
        private void dgvDanhSachNhanVien_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            load_NhanVienForm(dgvDanhSachNhanVien.Rows[r].Cells[0].Value.ToString());
